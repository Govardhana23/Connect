...
async function main() {
    ...
    const tailoring = await prisma.category.upsert({
    ...
    const rajeshProfile = await prisma.providerProfile.upsert({
    ...
    const sureshProfile = await prisma.providerProfile.upsert({
    ...
    const anitaProfile = await prisma.providerProfile.upsert({
    ...
    const mohammadUser = await prisma.user.upsert({
    ...
    const mohammadProfile = await prisma.providerProfile.upsert({
    ...
    // 5. Lakshmi (Painter)
    const lakshmiUser = await prisma.user.upsert({
    ...
    const lakshmiProfile = await prisma.providerProfile.upsert({
    ...
    const priyaProfile = await prisma.providerProfile.upsert({
